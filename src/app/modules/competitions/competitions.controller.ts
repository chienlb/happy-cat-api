...
export class CompetitionsController {
  ...
  async getAllCompetitions(
    ...
    return await this.competitionsService.findAllCompetitions(paginationDto);
  }
  ...
  async updateCompetition(
    ...
    return await this.competitionsService.updateCompetition(
      id,
  ...
  async getCompetitionsByUserId(
    ...
    return await this.competitionsService.findCompetitionsByUserId(
      userId,
      page,
      limit,
    );
