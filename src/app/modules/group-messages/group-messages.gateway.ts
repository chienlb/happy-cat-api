...
export class GroupMessagesGateway
    ...
    emitEditMessage(groupId: string, message: any) {
        ...
        logger.log(`Edit message emitted for message: ${message.id} to group: ${groupId}`);
    }
    ...
    emitDeleteMessage(groupId: string, messageId: string) {
        ...
        logger.log(`Delete message emitted for message: ${messageId} to group: ${groupId}`);
    }
    ...
    emitReadReceipt(groupId: string, messageId: string, userId: string) {
        ...
        logger.log(`Read receipt emitted for message: ${messageId} to user: ${userId}`);
    }
}
