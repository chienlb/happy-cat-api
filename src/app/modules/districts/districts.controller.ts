...
export class DistrictsController {
  ...
  @ApiBody({
    ...
    description: 'The district to create',
    examples: {
      normal: {
        summary: 'Example of a normal district',
        value: {
          districtId: '1234567890',
          districtName: 'District 1',
          districtCode: '1234567890',
          provinceCode: '1234567890',
        },
      },
    },
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The districts have been successfully retrieved.',
  })
  @ApiResponse({ status: 400, description: 'Bad request' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden' })
  ...
  @ApiBody({
    ...
    description: 'The district to update',
    examples: {
      normal: {
        summary: 'Example of a normal district',
        value: {
