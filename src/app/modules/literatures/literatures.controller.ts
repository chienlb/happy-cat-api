...
export class LiteraturesController {
    ...
    examples: {
      example1: {
        value: {
          ...
          topic: 'animals',
          contentEnglish:
            'The Lion King is a story about a lion king who is the king of the jungle.',
          contentVietnamese:
            'Truyện The Lion King là một câu chuyện về một con sư tử người láng giềng.',
  ...
  @ApiResponse({
    status: 201,
    description: 'The literature has been successfully created.',
    type: CreateLiteratureDto,
  })
  ...
  @ApiParam({
    name: 'id',
    type: String,
    description: 'The id of the literature',
  })
  @ApiResponse({
    status: 200,
    description: 'The literature has been successfully retrieved.',
    type: CreateLiteratureDto,
  })
  @ApiResponse({ status: 400, description: 'Bad Request', type: HttpException })
  ...
  @ApiBody({
    ...
    description: 'The literature to update',
  })
  @ApiResponse({
    status: 200,
    description: 'The literature has been successfully updated.',
    type: UpdateLiteratureDto,
  })
  @ApiResponse({ status: 400, description: 'Bad Request', type: HttpException })
  async updateLiteratureById(
    @Param('id') id: string,
  ...
  @ApiResponse({
    status: 200,
    description: 'The literature has been successfully restored.',
    type: CreateLiteratureDto,
  })
  @ApiResponse({ status: 400, description: 'Bad Request', type: HttpException })
  ...
  @ApiResponse({
    status: 200,
    description: 'The literature has been successfully changed.',
    type: CreateLiteratureDto,
  })
  @ApiResponse({ status: 400, description: 'Bad Request', type: HttpException })
  async changeLiteratureStatusById(
    @Param('id') id: string,
    @Body() status: boolean,
  ): Promise<any> {
