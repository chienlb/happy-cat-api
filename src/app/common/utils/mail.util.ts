...
export async function sendEmail(
    ...
    try {
        const logoUrl = 'https://res.cloudinary.com/dxkqibtzv/image/upload/v1765629897/Logo_web_oljdjn.png';
        ...
        if (logoBuffer && logoBuffer.length > 0) {
            ...
            logger.log(`Logo downloaded successfully, size: ${logoBuffer.length} bytes`);
        } else {
